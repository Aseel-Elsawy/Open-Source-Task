            ...
            public class Student : Person
            {
                ...
                public int Year
                {
                    ...
                    set
                    {
                        if (value < 1 || value > 5)
                        {
                            throw new Exception("Enter Correct Year");
                        }
                        _year = value;
                    }
                }
                ...
                public float Gpa
                {
                    ...
                    set
                    {
                        if (value < 0 || value > 4)
                        {
                            throw new Exception("Enter Correct Gpa");
                        }
                        _gpa = value;
                    }
                }
            ...
            public class Staff : Person
            {
                ...
                public int JoinYear
                {
                    ...
                    set
                    {
                        ...
                        if (compare <= 21)
                        {
                            throw new Exception("Enter Correct Join Year");
                        }
                        _joinYear = compare;
                    }
                }
